...
namespace P16Admintool
{
    ...
    public class ContextmenuAdministration
    {
        ...
        /// Gets the text of the menuitem for edit an element.
        /// </summary>
        public string TextMenuitemEdit
        {
            get
            {
        ...
        /// <summary>
        /// TODO : Read from the database.
        /// Gets the text of the menuitem for removing an element.
        /// </summary>
        public string TextMenuitemRemove
        {
            get
            {
                switch (CommonMethods.GetCurrentLanguage())
        ...
        private MenuItem CreateEditItemForContextmenu(FrameworkElement element)
        {
            ...
            menuitem.Header = TextMenuitemEdit;
        ...
        {
            MenuItem menuitem = new MenuItem();
            menuitem.Header = TextMenuitemRemove;
            menuitem.DataContext = element;
