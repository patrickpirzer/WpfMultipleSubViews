...
namespace P16Admintool
{
    ...
    public class DragAndResizeElementActions
    {
        ...
        public DragAndResizeElementActions(FrameworkElement windowForMaskDesign)
        {
        ...
        public void OnMouseUp(object sender, MouseButtonEventArgs e)
        {
            ...
            CommonMethods.DisplayCursor(defaultCursor, designerwindow);
        ...
        private void SetMouseCursor(FrameworkElement element)
        {
            ...
            {
                CommonMethods.DisplayCursor(desiredCursor, designerwindow);
            }
        }
